...
class Vector : AbstractList, List {
	...
	override public bool add(Object o) {
	...
	override public bool addAll(Collection c) {
		implMissing(__FILE__, __LINE__);
		return false;
	}

	override public bool addAll(int index, Collection c) {
		implMissing(__FILE__, __LINE__);
		return false;
	}
	...
	override public bool contains(Object elem) {
		implMissing(__FILE__, __LINE__);
		return false;
	}
	...
	override public bool containsAll(Collection c) {
		implMissing(__FILE__, __LINE__);
		return false;
	}
	...
	override public bool removeAll(Collection c) {
		implMissing(__FILE__, __LINE__);
		return false;
	}
	...
	override public bool retainAll(Collection c) {
		implMissing(__FILE__, __LINE__);
		return false;
	}
	...
	// only for D
	override public int opApply(int delegate(ref Object value) dg) {
		implMissing(__FILE__, __LINE__);
		return 0;
	}
