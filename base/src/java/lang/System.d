...
class System {
	...
	static long currentTimeMillis() {
		version (Tango)
			return tango.time.Clock.Clock.now().ticks() / 10000;
		else
	...
	public static String getProperty(String key) {
		...
		if (key[0 .. 3] == "org.eclipse.swt") {
			...
			case "file.separator":
				version (Tango)
					return tango.io.model.IFile.FileConst.PathSeparatorString;
				else
					return std.path.dirSeparator;
			default:
				return null;
			}
		}
