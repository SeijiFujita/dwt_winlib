...
class Thread {
	...
	version (Tango) {
		private alias TTLS = tango.core.Thread.ThreadLocal!(Thread);
	...
	public int getPriority() {
		return (thread.priority - TThread.PRIORITY_MIN) * (MAX_PRIORITY - MIN_PRIORITY) / (
				TThread.PRIORITY_MAX - TThread.PRIORITY_MIN) + MIN_PRIORITY;
	}
	...
	public void setPriority(int newPriority) {
		...
		auto scaledPrio = (newPriority - MIN_PRIORITY) * (TThread.PRIORITY_MAX - TThread.PRIORITY_MIN) / (
				MAX_PRIORITY - MIN_PRIORITY) + TThread.PRIORITY_MIN;
