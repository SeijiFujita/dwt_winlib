...
version (Tango) {
	...
	alias MathLib = tango.math.Math;
}
else {
	static import std.math;

	alias MathLib = std.math;
}
...
class Math {
	...
	static double sin(double a) {
		return MathLib.sin(a);
	}

	static double cos(double a) {
		return MathLib.cos(a);
	}

	static long round(double a) {
		return cast(long) MathLib.round(a);
	}

	static int round(float a) {
		return cast(int) MathLib.round(a);
	}
	...
	static double rint(double a) {
		version (Tango)
			return MathLib.rndint(a);
		else
			return MathLib.rint(a);
	}

	static double ceil(double a) {
		return MathLib.ceil(a);
	}

	static double floor(double a) {
		return MathLib.floor(a);
	}
