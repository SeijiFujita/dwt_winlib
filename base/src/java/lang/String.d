...
public bool equalsIgnoreCase(in char[] src, in char[] other) {
	version (Tango) {
		...
		return tango.text.Unicode.toFold(src, s1b) == tango.text.Unicode.toFold(other, s2b);
	}
	else { // Phobos
...
public int compareToIgnoreCase(in char[] src, in char[] other) {
	version (Tango) {
		...
		return compareTo(tango.text.Unicode.toFold(src, s1b), tango.text.Unicode.toFold(other, s2b));
	}
	else { // Phobos
...
public alias String_toHash = toHash;
...
version (Tango) {
	public alias toStringz = tango.stdc.stringz.toStringz;
	public alias toString16z = tango.stdc.stringz.toString16z;
	public alias fromStringz = tango.stdc.stringz.fromStringz;
	public alias fromString16z = tango.stdc.stringz.fromString16z;
