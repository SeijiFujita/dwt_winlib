 ...
 */
	...
	FormAttachment minus(FormAttachment attachment) {
		...
		solution.numerator = numerator * attachment.denominator - denominator * attachment
			.numerator;
 ...
 */
	public override String toString() {
		String string = control !is null ? control.toString() : Format("{}/{}",
				numerator, denominator);
		return Format("{{y = ({})x + {}}", string, (offset >= 0
				? Format(")x + {}", offset) : Format(")x - {}", -offset)));
	}
