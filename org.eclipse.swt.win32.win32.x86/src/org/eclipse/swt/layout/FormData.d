 ...
 */
	override public String toString() {
		...
		if (width !is SWT.DEFAULT)
			string ~= "width=" ~ String_valueOf(width) ~ " ";
		if (height !is SWT.DEFAULT)
			string ~= "height=" ~ String_valueOf(height) ~ " ";
		if (left !is null)
			string ~= "left=" ~ String_valueOf(left) ~ " ";
		if (right !is null)
			string ~= "right=" ~ String_valueOf(right) ~ " ";
		if (top !is null)
			string ~= "top=" ~ String_valueOf(top) ~ " ";
		if (bottom !is null)
			string ~= "bottom=" ~ String_valueOf(bottom) ~ " ";
		string = string.trim();
		string ~= "}";
		return string;
	}
