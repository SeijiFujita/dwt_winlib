...
alias OPENGL_NATIVE = org.eclipse.swt.internal.opengl.win32.native;
...
public:
	...
	alias ChoosePixelFormat = OPENGL_NATIVE.ChoosePixelFormat;
	alias DescribePixelFormat = OPENGL_NATIVE.DescribePixelFormat;
	alias GetPixelFormat = OPENGL_NATIVE.GetPixelFormat;
	alias SetPixelFormat = OPENGL_NATIVE.SetPixelFormat;
	alias SwapBuffers = OPENGL_NATIVE.SwapBuffers;

	alias wglCopyContext = OPENGL_NATIVE.wglCopyContext;
	alias wglCreateContext = OPENGL_NATIVE.wglCreateContext;
	alias wglCreateLayerContext = OPENGL_NATIVE.wglCreateLayerContext;
	alias wglDeleteContext = OPENGL_NATIVE.wglDeleteContext;
	alias wglGetCurrentContext = OPENGL_NATIVE.wglGetCurrentContext;
	alias wglGetCurrentDC = OPENGL_NATIVE.wglGetCurrentDC;
	alias wglGetProcAddress = OPENGL_NATIVE.wglGetProcAddress;
	alias wglMakeCurrent = OPENGL_NATIVE.wglMakeCurrent;
	alias wglShareLists = OPENGL_NATIVE.wglShareLists;
	alias wglDescribeLayerPlane = OPENGL_NATIVE.wglDescribeLayerPlane;
	alias wglSetLayerPaletteEntries = OPENGL_NATIVE.wglSetLayerPaletteEntries;
	alias wglGetLayerPaletteEntries = OPENGL_NATIVE.wglGetLayerPaletteEntries;
	alias wglRealizeLayerPalette = OPENGL_NATIVE.wglRealizeLayerPalette;
	alias wglSwapLayerBuffers = OPENGL_NATIVE.wglSwapLayerBuffers;
}
