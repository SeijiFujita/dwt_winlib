...
alias GdiplusStartupInput = org.eclipse.swt.internal.gdip.native.GdiplusStartupInput;
alias GdiplusStartupOutput = org.eclipse.swt.internal.gdip.native.GdiplusStartupOutput;
...
public:
	...
	alias Rect = GpRect;
	alias RectF = GpRectF;
	alias BitmapData = GpBitmapData;
	alias ColorPalette = GpColorPalette;
	alias DrawImageAbort = GpDrawImageAbort;
	alias ColorMatrix = GpColorMatrix;

	alias FontFamily = GpFontFamily;
	alias Image = GpImage;
	alias Brush = GpBrush;
	alias Font = GpFont;
	alias FontCollection = GpFontCollection;
	alias Graphics = GpGraphics;
	alias GraphicsPath = GpGraphicsPath;
	alias ImageAttributes = GpImageAttributes;
	alias HatchBrush = GpHatchBrush;
	alias LinearGradientBrush = GpLinearGradientBrush;
	alias Matrix = GpMatrix;
	alias Pen = GpPen;
	alias Region = GpRegion;
	alias SolidBrush = GpSolidBrush;
	alias StringFormat = GpStringFormat;
	alias TextureBrush = GpTextureBrush;
	alias Path = GpPath;
    ...
    **************************************************************************/
	...
	enum {
		...
		PixelFormat32bppPARGB = (11 | (
				32 << 8) | PixelFormatAlpha | PixelFormatPAlpha | PixelFormatGDI),
	...
	static ARGB MakeARGB(ubyte a, ubyte r, ubyte g, ubyte b) {
		return ((cast(ARGB)(b) << Gdip.BlueShift) | (cast(ARGB)(
				g) << Gdip.GreenShift) | (cast(ARGB)(r) << Gdip.RedShift) | (
...
public:
    ...
    **************************************************************************/
	...
	static int Bitmap_GetHBITMAP(Bitmap bitmap, ARGB colorBackground, out HBITMAP hbmReturn) {
		return SetStatus(GdipCreateHBITMAPFromBitmap(bitmap, hbmReturn, colorBackground));
	}
    ...
    **************************************************************************/
	...
	static int Bitmap_LockBits(Bitmap bitmap, Rect* rect, uint flags,
			PixelFormat pixelFormat, BitmapData* lockedBitmapData) {
		return SetStatus(GdipBitmapLockBits(bitmap, rect, flags, pixelFormat, lockedBitmapData));
	}
    ...
    **************************************************************************/
	...
	static Bitmap Bitmap_new(int width, int height, int stride, PixelFormat format, ubyte* scan0) {
		Bitmap bitmap;
		Gdip.lastResult = GdipCreateBitmapFromScan0(width, height, stride, format, scan0, bitmap);
		return bitmap;
	}
...
**************************************************************************/
    ...
    **************************************************************************/
	...
	static Status ImageAttributes_SetWrapMode(ImageAttributes attrib,
			WrapMode wrap, ARGB color = Gdip.Black, bool clamp = false) {
		return SetStatus(GdipSetImageAttributesWrapMode(attrib, wrap, color, clamp));
	}
    ...
    **************************************************************************/
	...
	static Status ImageAttributes_SetColorMatrix(ImageAttributes attrib, ref ColorMatrix matrix,
			ColorMatrixFlag mode = Gdip.ColorMatrixFlagsDefault,
			ColorAdjustType type = Gdip.ColorAdjustTypeDefault) {
		return SetStatus(GdipSetImageAttributesColorMatrix(attrib, type, true,
				&matrix, null, mode));
	}
...
**************************************************************************/
    ...
    **************************************************************************/
	...
	static HatchBrush HatchBrush_new(HatchStyle hatchStyle, ARGB foreColor, ARGB backColor) {
		...
		Gdip.lastResult = GdipCreateHatchBrush(hatchStyle, foreColor, backColor, brush);
		return brush;
	}
...
**************************************************************************/
	...
	static LinearGradientBrush LinearGradientBrush_new(ref PointF point1,
			ref PointF point2, ARGB color1, ARGB color2) {
    ...
    **************************************************************************/
	...
	static Status LinearGradientBrush_SetInterpolationColors(LinearGradientBrush brush,
		...
		return SetStatus(GdipSetLinePresetBlend(brush, presetColors, blendPositions, count));
	}
    ...
    **************************************************************************/
	...
	static int LinearGradientBrush_ScaleTransform(LinearGradientBrush brush,
			float sx, float sy, MatrixOrder order = MatrixOrderPrepend) {
    ...
    **************************************************************************/
	...
	static int LinearGradientBrush_TranslateTransform(LinearGradientBrush brush,
			float dx, float dy, MatrixOrder order = MatrixOrderPrepend) {
...
**************************************************************************/
	...
	static TextureBrush TextureBrush_new(Image image, WrapMode wrapMode,
		...
		Gdip.lastResult = GdipCreateTexture2(image, wrapMode, dstX, dstY,
				dstWidth, dstHeight, brush);
		return brush;
    ...
    **************************************************************************/
	...
	static Status TextureBrush_ScaleTransform(TextureBrush brush, float sx,
			float sy, MatrixOrder order = MatrixOrderPrepend) {
    ...
    **************************************************************************/
	...
	static Status TextureBrush_TranslateTransform(TextureBrush brush, float dx,
			float dy, MatrixOrder order = MatrixOrderPrepend) {
...
**************************************************************************/
    ...
    **************************************************************************/
	...
	static Status GraphicsPath_AddArcF(Path path, float x, float y, float width,
			float height, float startAngle, float sweepAngle) {
		return SetStatus(GdipAddPathArc(path, x, y, width, height, startAngle, sweepAngle));
	}
    ...
    **************************************************************************/
	...
	static Status GraphicsPath_AddArc(Path path, int x, int y, int width,
			int height, float startAngle, float sweepAngle) {
		return SetStatus(GdipAddPathArcI(path, x, y, width, height, startAngle, sweepAngle));
	}
    ...
    **************************************************************************/
	...
	static Status GraphicsPath_AddBezier(Path path, float x1, float y1, float x2,
			float y2, float x3, float y3, float x4, float y4) {
		return SetStatus(GdipAddPathBezier(path, x1, y1, x2, y2, x3, y3, x4, y4));
	}
    ...
    **************************************************************************/
	...
	static Status GraphicsPath_AddRectangle(Path path, RectF rect) {
		return SetStatus(GdipAddPathRectangle(path, rect.X, rect.Y, rect.Width, rect.Height));
	}
    ...
    **************************************************************************/
	...
	static Status GraphicsPath_AddString(Path path, LPCWSTR string, int length,
			FontFamily family, int style, float emSize, ref PointF origin, StringFormat format) {
		RectF rect = {origin.X, origin.Y, 0.0f, 0.0f};

		return SetStatus(GdipAddPathString(path, string, length, family, style,
				emSize, rect, format));
	}
    ...
    **************************************************************************/
	...
	static Status GraphicsPath_GetBounds(Path path, ref RectF bounds, Matrix matrix, Pen pen) {
		...
		return SetStatus(GdipGetPathWorldBounds(path, bounds, matrix, pen));
	}
    ...
    **************************************************************************/
	...
	static bool GraphicsPath_IsOutlineVisible(Path path, float x, float y, Pen pen, Graphics g = null) {
		int booln = false;
		SetStatus(GdipIsOutlineVisiblePathPoint(path, x, y, pen, g, booln));
		return (booln == true);
	}
...
**************************************************************************/
    ...
    **************************************************************************/
	...
	static Status Graphics_DrawArc(Graphics graphics, Pen pen, int x, int y,
			int width, int height, float startAngle, float sweepAngle) {
		return SetStatus(GdipDrawArcI(graphics, pen, x, y, width, height, startAngle, sweepAngle));
	}
    ...
    **************************************************************************/
	...
	static Status Graphics_DrawEllipse(Graphics graphics, Pen pen, int x,
			int y, int width, int height) {
		return SetStatus(GdipDrawEllipseI(graphics, pen, x, y, width, height));
	}
    ...
    **************************************************************************/
	...
	static Status Graphics_DrawImage(Graphics graphics, Image image, ref Rect destRect, int srcx, int srcy, int srcwidth,
			int srcheight, Unit srcUnit, ImageAttributes imageAttributes = null,
			DrawImageAbort callback = null, void* callbackData = null) {
		return SetStatus(GdipDrawImageRectRectI(graphics, image, destRect.X, destRect.Y,
				destRect.Width, destRect.Height, srcx, srcy, srcwidth,
    ...
    **************************************************************************/
	...
	static Status Graphics_DrawRectangle(Graphics graphics, Pen pen, int x,
			int y, int width, int height) {
    ...
    **************************************************************************/
	...
	static Status Graphics_DrawString(Graphics graphics, LPCWSTR string,
			int length, Font font, ref PointF origin, Brush brush) {
		RectF rect = {origin.X, origin.Y, 0.0f, 0.0f};
    ...
    **************************************************************************/
	...
	static Status Graphics_DrawString(Graphics graphics, LPCWSTR string,
			int length, Font font, ref PointF origin, StringFormat format, Brush brush) {
		RectF rect = {origin.X, origin.Y, 0.0f, 0.0f};
    ...
    **************************************************************************/
	...
	static Status Graphics_FillEllipse(Graphics graphics, Brush brush, int x,
			int y, int width, int height) {
    ...
    **************************************************************************/
	...
	static Status Graphics_FillPie(Graphics graphics, Brush brush, int x, int y,
			int width, int height, float startAngle, float sweepAngle) {
		return SetStatus(GdipFillPieI(graphics, brush, x, y, width, height,
    ...
    **************************************************************************/
	...
	static Status Graphics_FillRectangle(Graphics graphics, Brush brush, int x,
			int y, int width, int height) {
		return SetStatus(GdipFillRectangleI(graphics, brush, x, y, width, height));
	}
    ...
    **************************************************************************/
	...
	static Status Graphics_MeasureString(Graphics graphics, LPCWSTR string,
			int length, Font font, ref PointF origin, ref RectF boundingBox) {
		RectF rect = {origin.X, origin.Y, 0.0f, 0.0f};

		return SetStatus(GdipMeasureString(graphics, string, length, font,
				rect, null, boundingBox, null, null));
	}
    ...
    **************************************************************************/
	...
	static Status Graphics_MeasureString(Graphics graphics, LPCWSTR string, int length,
			Font font, ref PointF origin, StringFormat format, ref RectF boundingBox) {
		RectF rect = {origin.X, origin.Y, 0.0f, 0.0f};

		return SetStatus(GdipMeasureString(graphics, string, length, font,
				rect, format, boundingBox, null, null));
	}
    ...
    **************************************************************************/
	...
	static Status Graphics_SetClip(Graphics graphics, ref Rect rect,
			CombineMode combineMode = CombineModeReplace) {
		return SetStatus(GdipSetClipRectI(graphics, rect.X, rect.Y, rect.Width,
    ...
    **************************************************************************/
	...
	static Status Graphics_TranslateTransform(Graphics graphics, float dx,
			float dy, MatrixOrder order = MatrixOrderPrepend) {
...
**************************************************************************/
    ...
    **************************************************************************/
	...
	static StringFormat StringFormat_GenericDefault() {
		...
		StringFormat genericDefaultStringFormat = cast(StringFormat) GenericDefaultStringFormatBuffer;
    ...
    **************************************************************************/
	...
	static StringFormat StringFormat_GenericTypographic() {
		// TODO:  do we need to access buffer through "ptr" property?
		StringFormat genericTypographicStringFormat = cast(StringFormat) GenericTypographicStringFormatBuffer;

		Gdip.lastResult = GdipStringFormatGetGenericTypographic(genericTypographicStringFormat);
    ...
    **************************************************************************/
	...
	static int StringFormat_SetTabStops(StringFormat format,
			float firstTabOffset, int count, float* tabStops) {
		return SetStatus(GdipSetStringFormatTabStops(format, firstTabOffset, count, tabStops));
	}
