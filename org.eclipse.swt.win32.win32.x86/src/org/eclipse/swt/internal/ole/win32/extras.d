...
//alias CLSID * LPCLSID;
alias REFGUID = GUID*;
alias REFCGUID = TryConst!(GUID)*;

//alias IID *REFIID;

alias REFCLSID = CLSID*;
...
alias wireCLIPFORMAT = userCLIPFORMAT*;

alias CLIPFORMAT = WORD;

alias HMETAFILEPICT = void*;
// typeless hack
alias wireHGLOBAL = void*;
alias wireHBITMAP = void*;
alias wireHPALETTE = void*;
alias wireHENHMETAFILE = void*;
alias wireHMETAFILE = void*;
alias wireHMETAFILEPICT = void*;
...
alias UP_DWORD_BLOB = DWORD_BLOB*;
