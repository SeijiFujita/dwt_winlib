...
*/
	...
	interface IParseDisplayName : IUnknown {
		HRESULT ParseDisplayName(IBindCtx pbc, LPOLESTR pszDisplayName,
	...
	alias LINKSRCDESCRIPTOR = OBJECTDESCRIPTOR;
	alias POBJECTDESCRIPTOR = OBJECTDESCRIPTOR*;
	alias LPOBJECTDESCRIPTOR = OBJECTDESCRIPTOR*;
	alias PLINKSRCDESCRIPTOR = OBJECTDESCRIPTOR*;
	alias LPLINKSRCDESCRIPTOR = OBJECTDESCRIPTOR*;
	...
	alias LPOLEUPDATE = OLEUPDATE*;
	alias POLEUPDATE = OLEUPDATE*;
	...
	interface IOleItemContainer : IOleContainer {
		HRESULT GetObject(LPOLESTR pszItem, DWORD dwSpeedNeeded, IBindCtx pbc,
	...
	interface IViewObject : IUnknown {
		HRESULT Draw(DWORD dwDrawAspect, LONG lindex, void* pvAspect, DVTARGETDEVICE* ptd, HDC hdcTargetDev, HDC hdcDraw,
				LPCRECTL lprcBounds, LPCRECTL lprcWBounds,
				BOOL function(ULONG_PTR dwContinue) pfnContinue, ULONG_PTR dwContinue);
