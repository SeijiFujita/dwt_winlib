...
*/
	...
	alias SAFEARRAYUNION = SAFEARRAY_UNION;
...
+/
	...
	interface ITypeInfo : IUnknown {
		...
		HRESULT GetDocumentation(MEMBERID memid, BSTR* pBstrName,
				BSTR* pBstrDocString, DWORD* pdwHelpContext, BSTR* pBstrHelpFile);
		HRESULT GetDllEntry(MEMBERID memid, INVOKEKIND invKind,
	...
	interface ITypeInfo2 : ITypeInfo {
		...
		HRESULT GetDocumentation2(MEMBERID memid, LCID lcid, BSTR* pbstrHelpString,
	...
	interface ITypeLib : IUnknown {
		...
		HRESULT GetDocumentation(INT index, BSTR* pBstrName,
				BSTR* pBstrDocString, DWORD* pdwHelpContext, BSTR* pBstrHelpFile);
	...
	interface ITypeLib2 : ITypeLib {
		...
		HRESULT GetDocumentation2(INT index, LCID lcid, BSTR* pbstrHelpString,
				DWORD* pdwHelpStringContext, BSTR* pbstrHelpStringDll);
		HRESULT GetAllCustData(CUSTDATA* pCustData);
	}
	...
	interface ITypeChangeEvents : IUnknown {
		...
		HRESULT RequestTypeChange(CHANGEKIND changeKind, ITypeInfo pTInfoBefore,
				LPOLESTR pStrName, INT* pfCancel);
	...
	interface ITypeMarshal : IUnknown {
		...
		HRESULT Marshal(PVOID pvType, DWORD dwDestContext, PVOID pvDestContext,
				ULONG cbBufferLength, BYTE* pBuffer, ULONG* pcbWritten);
		HRESULT Unmarshal(PVOID pvType, DWORD dwFlags, ULONG cbBufferLength,
				BYTE* pBuffer, ULONG* pcbRead);
	...
	interface IRecordInfo : IUnknown {
		...
		HRESULT PutFieldNoCopy(ULONG wFlags, PVOID pvData,
