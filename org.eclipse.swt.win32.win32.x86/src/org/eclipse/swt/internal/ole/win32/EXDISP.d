...
extern (Windows) {
	...
	interface IWebBrowser : IDispatch {
		...
		HRESULT Navigate(BSTR URL, VARIANT* Flags, VARIANT* TargetFrameName,
   ...
   */
	...
	interface IWebBrowser2 : IWebBrowserApp {
		HRESULT Navigate2(VARIANT* URL, VARIANT* Flags,
    ...
    */
	...
	interface IShellWindows : IDispatch {
		...
		HRESULT RegisterPending(LONG lThreadId, VARIANT* pvarloc, // will hold pidl that is being opened.
				VARIANT* pvarlocRoot, // Optional root pidl
				int swClass, LONG* plCookie);
		...
		HRESULT FindWindow(VARIANT* pvarLoc, VARIANT* pvarLocRoot, int swClass,
