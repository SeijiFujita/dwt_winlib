...
interface IOleCommandTarget;
  */
	...
	interface IOleDocument : IUnknown {
		HRESULT CreateView(IOleInPlaceSite pIPSite, IStream pstm,
	...
	alias LPOLEDOCUMENT = IOleDocument;
	...
	alias LPOLEDOCUMENTSITE = IOleDocumentSite;
	...
	interface IOleDocumentView : IUnknown {
		...
		HRESULT SetRectComplex(LPRECT prcView, LPRECT prcHScroll,
	...
	alias LPOLEDOCUMENTVIEW = IOleDocumentView;
	...
	alias LPCONTINUECALLBACK = IContinueCallback;
...
cpp_quote("#define MSOCMDERR_E_UNKNOWNGROUP OLECMDERR_E_UNKNOWNGROUP")
  */
		HRESULT QueryStatus(GUID* pguidCmdGroup, ULONG cCmds, OLECMD* prgCmds,
				OLECMDTEXT* pCmdText);

		HRESULT Exec(GUID* pguidCmdGroup, DWORD nCmdID, DWORD nCmdexecopt,
				VARIANT* pvaIn, VARIANT* pvaOut);
	}

	alias LPOLECOMMANDTARGET = IOleCommandTarget;
	/*
