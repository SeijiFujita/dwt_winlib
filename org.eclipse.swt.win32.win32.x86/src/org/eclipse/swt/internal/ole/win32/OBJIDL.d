 ...
 ****************************************************************************/
	...
	interface IMarshal : IUnknown {
		...
		HRESULT GetMarshalSizeMax(REFIID riid, void* pv, DWORD dwDestContext,
				void* pvDestContext, DWORD mshlflags, DWORD* pSize);
		HRESULT MarshalInterface(IStream pStm, REFIID riid, void* pv,
 ...
 ****************************************************************************/
	...
	interface IMoniker : IPersistStream {
		...
		HRESULT Reduce(IBindCtx pbc, DWORD dwReduceHowFar, IMoniker* ppmkToLeft,
		...
		HRESULT ParseDisplayName(IBindCtx pbc, IMoniker pmkToLeft,
 ...
 ****************************************************************************/
	...
	interface IStorage : IUnknown {
		...
		HRESULT OpenStream(LPCOLESTR pwcsName, void* reserved1, DWORD grfMode,
				DWORD reserved2, IStream* ppstm);
		HRESULT CreateStorage(LPCOLESTR pwcsName, DWORD grfMode, DWORD reserved1,
				DWORD reserved2, IStorage* ppstg);
		HRESULT OpenStorage(LPCOLESTR pwcsName, IStorage pstgPriority,
		...
		HRESULT MoveElementTo(LPCOLESTR pwcsName, IStorage pstgDest,
				LPCOLESTR pwcsNewName, DWORD grfFlags);
		HRESULT Commit(DWORD grfCommitFlags);
		HRESULT Revert();
		HRESULT EnumElements(DWORD reserved1, void* reserved2,
		...
		HRESULT SetElementTimes(LPCOLESTR pwcsName, FILETIME* pctime,
...
*/
	...
	alias wireSTGMEDIUM = userSTGMEDIUM*;
	alias STGMEDIUM = uSTGMEDIUM;
	alias wireASYNC_STGMEDIUM = userSTGMEDIUM*;
	...
	alias wireFLAG_STGMEDIUM = userFLAG_STGMEDIUM*;
	...
	interface IDataAdviseHolder : IUnknown {
		HRESULT Advise(IDataObject pDataObject, FORMATETC* pFetc, DWORD advf,
	...
	interface IMessageFilter : IUnknown {
		...
		DWORD HandleInComingCall(DWORD dwCallType, HTASK htaskCaller,
