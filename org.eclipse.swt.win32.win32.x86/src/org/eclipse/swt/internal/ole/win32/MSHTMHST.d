...
*/
	...
	interface IDocHostUIHandler : IUnknown {
		HRESULT ShowContextMenu(DWORD dwID, POINT* ppt, IUnknown pcmdtReserved,
	...
	interface IDocHostShowUI : IUnknown {
		HRESULT ShowMessage(HWND hwnd, LPOLESTR lpstrText, LPOLESTR lpstrCaption,
				DWORD dwType, LPOLESTR lpstrHelpFile, DWORD dwHelpContext, LRESULT* plResult);
		HRESULT ShowHelp(HWND hwnd, LPOLESTR pszHelpFile, UINT uCommand,
