...
private alias COMAPI = org.eclipse.swt.internal.ole.win32.COMAPI;
...
template IIDFromStringT(String g) {
	static if (g.length == 38)
		...
		const GUID IIDFromStringT = GUID(mixin("0x" ~ g[0 .. 8]),
				mixin("0x" ~ g[9 .. 13]), mixin("0x" ~ g[14 .. 18]),
				[mixin("0x" ~ g[19 .. 21]), mixin("0x" ~ g[21 .. 23]),
				mixin("0x" ~ g[24 .. 26]), mixin("0x" ~ g[26 .. 28]),
				mixin("0x" ~ g[28 .. 30]), mixin("0x" ~ g[30 .. 32]),
				mixin("0x" ~ g[32 .. 34]), mixin("0x" ~ g[34 .. 36])]);
	else
...
public class COM : OS {
	...
	/** GUID Constants */
	public static const GUID IIDJavaBeansBridge = IIDFromStringT!(
			"{8AD9C840-044E-11D1-B3E9-00805F499D93}"); //$NON-NLS-1$
	public static const GUID IIDShockwaveActiveXControl = IIDFromStringT!(
			"{166B1BCA-3F9C-11CF-8075-444553540000}"); //$NON-NLS-1$
	public static const GUID IIDIEditorSiteTime = IIDFromStringT!(
			"{6BD2AEFE-7876-45e6-A6E7-3BFCDF6540AA}"); //$NON-NLS-1$
	public static const GUID IIDIEditorSiteProperty = IIDFromStringT!(
			"{D381A1F4-2326-4f3c-AFB9-B7537DB9E238}"); //$NON-NLS-1$
	public static const GUID IIDIEditorBaseProperty = IIDFromStringT!(
			"{61E55B0B-2647-47c4-8C89-E736EF15D636}"); //$NON-NLS-1$
	public static const GUID IIDIEditorSite = IIDFromStringT!(
			"{CDD88AB9-B01D-426E-B0F0-30973E9A074B}"); //$NON-NLS-1$
	public static const GUID IIDIEditorService = IIDFromStringT!(
			"{BEE283FE-7B42-4FF3-8232-0F07D43ABCF1}"); //$NON-NLS-1$
	public static const GUID IIDIEditorManager = IIDFromStringT!(
			"{EFDE08C4-BE87-4B1A-BF84-15FC30207180}"); //$NON-NLS-1$
	public static const GUID IIDIAccessible = IIDFromStringT!(
			"{618736E0-3C3D-11CF-810C-00AA00389B71}"); //$NON-NLS-1$
	...
	public static const GUID IIDIAdviseSink = IIDFromStringT!(
			"{0000010F-0000-0000-C000-000000000046}"); //$NON-NLS-1$
	...
	public static const GUID IIDIClassFactory = IIDFromStringT!(
			"{00000001-0000-0000-C000-000000000046}"); //$NON-NLS-1$
	public static const GUID IIDIClassFactory2 = IIDFromStringT!(
			"{B196B28F-BAB4-101A-B69C-00AA00341D07}"); //$NON-NLS-1$
	public static const GUID IIDIConnectionPoint = IIDFromStringT!(
			"{B196B286-BAB4-101A-B69C-00AA00341D07}"); //$NON-NLS-1$
	public static const GUID IIDIConnectionPointContainer = IIDFromStringT!(
			"{B196B284-BAB4-101A-B69C-00AA00341D07}"); //$NON-NLS-1$
	...
	public static const GUID IIDIDataObject = IIDFromStringT!(
			"{0000010E-0000-0000-C000-000000000046}"); //$NON-NLS-1$
	public static const GUID IIDIDispatch = IIDFromStringT!(
			"{00020400-0000-0000-C000-000000000046}"); //$NON-NLS-1$
	public static const GUID IIDIDocHostUIHandler = IIDFromStringT!(
			"{BD3F23C0-D43E-11CF-893B-00AA00BDCE1A}"); //$NON-NLS-1$
	public static const GUID IIDIDocHostShowUI = IIDFromStringT!(
			"{C4D244B0-D43E-11CF-893B-00AA00BDCE1A}"); //$NON-NLS-1$
	public static const GUID IIDIDropSource = IIDFromStringT!(
			"{00000121-0000-0000-C000-000000000046}"); //$NON-NLS-1$
	public static const GUID IIDIDropTarget = IIDFromStringT!(
			"{00000122-0000-0000-C000-000000000046}"); //$NON-NLS-1$
	...
	public static const GUID IIDIEnumFORMATETC = IIDFromStringT!(
			"{00000103-0000-0000-C000-000000000046}"); //$NON-NLS-1$
	...
	public static const GUID IIDIEnumVARIANT = IIDFromStringT!(
			"{00020404-0000-0000-C000-000000000046}"); //$NON-NLS-1$
	...
	public static const GUID IIDIInternetSecurityManager = IIDFromStringT!(
			"{79eac9ee-baf9-11ce-8c82-00aa004ba90b}"); //$NON-NLS-1$
	...
	public static const GUID IIDIOleClientSite = IIDFromStringT!(
			"{00000118-0000-0000-C000-000000000046}"); //$NON-NLS-1$
	public static const GUID IIDIOleCommandTarget = IIDFromStringT!(
			"{B722BCCB-4E68-101B-A2BC-00AA00404770}"); //$NON-NLS-1$
	public static const GUID IIDIOleContainer = IIDFromStringT!(
			"{0000011B-0000-0000-C000-000000000046}"); //$NON-NLS-1$
	public static const GUID IIDIOleControl = IIDFromStringT!(
			"{B196B288-BAB4-101A-B69C-00AA00341D07}"); //$NON-NLS-1$
	public static const GUID IIDIOleControlSite = IIDFromStringT!(
			"{B196B289-BAB4-101A-B69C-00AA00341D07}"); //$NON-NLS-1$
	public static const GUID IIDIOleDocument = IIDFromStringT!(
			"{B722BCC5-4E68-101B-A2BC-00AA00404770}"); //$NON-NLS-1$
	public static const GUID IIDIOleDocumentSite = IIDFromStringT!(
			"{B722BCC7-4E68-101B-A2BC-00AA00404770}"); //$NON-NLS-1$
	public static const GUID IIDIOleInPlaceActiveObject = IIDFromStringT!(
			"{00000117-0000-0000-C000-000000000046}"); //$NON-NLS-1$
	public static const GUID IIDIOleInPlaceFrame = IIDFromStringT!(
			"{00000116-0000-0000-C000-000000000046}"); //$NON-NLS-1$
	public static const GUID IIDIOleInPlaceObject = IIDFromStringT!(
			"{00000113-0000-0000-C000-000000000046}"); //$NON-NLS-1$
	public static const GUID IIDIOleInPlaceSite = IIDFromStringT!(
			"{00000119-0000-0000-C000-000000000046}"); //$NON-NLS-1$
	public static const GUID IIDIOleInPlaceUIWindow = IIDFromStringT!(
			"{00000115-0000-0000-C000-000000000046}"); //$NON-NLS-1$
	...
	public static const GUID IIDIOleObject = IIDFromStringT!(
			"{00000112-0000-0000-C000-000000000046}"); //$NON-NLS-1$
	public static const GUID IIDIOleWindow = IIDFromStringT!(
			"{00000114-0000-0000-C000-000000000046}"); //$NON-NLS-1$
	...
	public static const GUID IIDIPersistFile = IIDFromStringT!(
			"{0000010B-0000-0000-C000-000000000046}"); //$NON-NLS-1$
	...
	public static const GUID IIDIPersistStorage = IIDFromStringT!(
			"{0000010A-0000-0000-C000-000000000046}"); //$NON-NLS-1$
	public static const GUID IIDIPersistStream = IIDFromStringT!(
			"{00000109-0000-0000-C000-000000000046}"); //$NON-NLS-1$
	public static const GUID IIDIPersistStreamInit = IIDFromStringT!(
			"{7FD52380-4E07-101B-AE2D-08002B2EC713}"); //$NON-NLS-1$
	...
	public static const GUID IIDIPropertyNotifySink = IIDFromStringT!(
			"{9BFBBC02-EFF1-101A-84ED-00AA00341D07}"); //$NON-NLS-1$
	...
	public static const GUID IIDIProvideClassInfo = IIDFromStringT!(
			"{B196B283-BAB4-101A-B69C-00AA00341D07}"); //$NON-NLS-1$
	public static const GUID IIDIProvideClassInfo2 = IIDFromStringT!(
			"{A6BC3AC0-DBAA-11CE-9DE3-00AA004BB851}"); //$NON-NLS-1$
	...
	public static const GUID IIDIServiceProvider = IIDFromStringT!(
			"{6d5140c1-7436-11ce-8034-00aa006009fa}"); //$NON-NLS-1$
	public static const GUID IIDISpecifyPropertyPages = IIDFromStringT!(
			"{B196B28B-BAB4-101A-B69C-00AA00341D07}"); //$NON-NLS-1$
	...
	public static const GUID IIDIViewObject2 = IIDFromStringT!(
			"{00000127-0000-0000-C000-000000000046}"); //$NON-NLS-1$
	public static const GUID CGID_DocHostCommandHandler = IIDFromStringT!(
			"{f38bc242-b950-11d1-8918-00c04fc2c836}"); //$NON-NLS-1$
	public static const GUID CGID_Explorer = IIDFromStringT!(
			"{000214D0-0000-0000-C000-000000000046}"); //$NON-NLS-1$
	...
	alias CLSIDFromProgID = COMAPI.CLSIDFromProgID;
	alias CLSIDFromString = COMAPI.CLSIDFromString;
	alias CoCreateInstance = COMAPI.CoCreateInstance;
	alias CoFreeUnusedLibraries = COMAPI.CoFreeUnusedLibraries;
	alias CoGetClassObject = COMAPI.CoGetClassObject;
	alias CoLockObjectExternal = COMAPI.CoLockObjectExternal;
	alias CoTaskMemAlloc = COMAPI.CoTaskMemAlloc;
	alias CoTaskMemFree = COMAPI.CoTaskMemFree;
	alias CreateStdAccessibleObject = COMAPI.CreateStdAccessibleObject;
	alias CreateStreamOnHGlobal = COMAPI.CreateStreamOnHGlobal;
	alias DoDragDrop = COMAPI.DoDragDrop;
	alias GetClassFile = COMAPI.GetClassFile;
	alias IIDFromString = COMAPI.IIDFromString;
	alias IsEqualGUID = COMAPI.IsEqualGUID;
	alias LresultFromObject = COMAPI.LresultFromObject;
	alias OleCreate = COMAPI.OleCreate;
	alias OleCreateFromFile = COMAPI.OleCreateFromFile;
	alias OleCreatePropertyFrame = COMAPI.OleCreatePropertyFrame;
	alias OleDraw = COMAPI.OleDraw;
	alias OleFlushClipboard = COMAPI.OleFlushClipboard;
	alias OleGetClipboard = COMAPI.OleGetClipboard;
	alias OleIsCurrentClipboard = COMAPI.OleIsCurrentClipboard;
	alias OleIsRunning = COMAPI.OleIsRunning;
	alias OleLoad = COMAPI.OleLoad;
	alias OleRun = COMAPI.OleRun;
	alias OleSave = COMAPI.OleSave;
	alias OleSetClipboard = COMAPI.OleSetClipboard;
	alias OleSetContainedObject = COMAPI.OleSetContainedObject;
	alias OleSetMenuDescriptor = COMAPI.OleSetMenuDescriptor;
	alias OleTranslateColor = COMAPI.OleTranslateColor;
	alias ProgIDFromCLSID = COMAPI.ProgIDFromCLSID;
	alias RegisterDragDrop = COMAPI.RegisterDragDrop;
	alias ReleaseStgMedium = COMAPI.ReleaseStgMedium;
	alias RevokeDragDrop = COMAPI.RevokeDragDrop;
	alias SHDoDragDrop = COMAPI.SHDoDragDrop;
	alias StgCreateDocfile = COMAPI.StgCreateDocfile;
	alias StgIsStorageFile = COMAPI.StgIsStorageFile;
	alias StgOpenStorage = COMAPI.StgOpenStorage;
	alias StringFromCLSID = COMAPI.StringFromCLSID;
	alias SysAllocString = COMAPI.SysAllocString;
	alias SysFreeString = COMAPI.SysFreeString;
	alias SysStringByteLen = COMAPI.SysStringByteLen;
	alias VariantChangeType = COMAPI.VariantChangeType;
	alias VariantClear = COMAPI.VariantClear;
	alias VariantCopy = COMAPI.VariantCopy;
	alias VariantInit = COMAPI.VariantInit;
	alias WriteClassStg = COMAPI.WriteClassStg;
