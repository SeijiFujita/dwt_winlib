 ...
 */
	override public void javaToNative(Object object, TransferData transferData) {
		...
		case COM.CF_TEXT: {
				...
				int cchMultiByte = OS.WideCharToMultiByte(codePage, 0,
						chars.ptr, -1, null, 0, null, null);
				if (cchMultiByte is 0) {
					transferData.stgmedium = new STGMEDIUM();
					transferData.result = COM.DV_E_STGMEDIUM;
					return;
				}
				auto lpMultiByteStr = cast(CHAR*) OS.GlobalAlloc(COM.GMEM_FIXED | COM.GMEM_ZEROINIT,
						cchMultiByte);
				OS.WideCharToMultiByte(codePage, 0, chars.ptr, -1,
