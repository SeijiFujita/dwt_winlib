 ...
 */
	override public void javaToNative(Object object, TransferData transferData) {
		...
		int cchMultiByte = OS.WideCharToMultiByte(codePage, 0, chars.ptr,
				-1, null, 0, null, null);
		...
		auto lpMultiByteStr = cast(CHAR*) OS.GlobalAlloc(OS.GMEM_FIXED | OS.GMEM_ZEROINIT,
				cchMultiByte);
		OS.WideCharToMultiByte(codePage, 0, chars.ptr, -1, lpMultiByteStr,
 ...
 */
	override public Object nativeToJava(TransferData transferData) {
		...
		try {
			...
			try {
				...
				OS.MultiByteToWideChar(codePage, OS.MB_PRECOMPOSED, lpMultiByteStr,
						-1, lpWideCharStr.ptr, cast(int) /*64bit*/ lpWideCharStr.length);
	...
	bool checkURL(Object object) {
		return object !is null && (null !is cast(ArrayWrapperString) object)
			&& (cast(ArrayWrapperString) object).array.length > 0;
