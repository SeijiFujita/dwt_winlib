 ...
 */
	override public String toString() {
		...
		string ~= "r:" ~ String_valueOf(redSize) ~ " g:" ~ String_valueOf(greenSize) ~ " b:" ~ String_valueOf(
				blueSize) ~ " a:" ~ String_valueOf(alphaSize) ~ "," ~ "depth:" ~ String_valueOf(
				depthSize) ~ ",stencil:" ~ String_valueOf(
				stencilSize) ~ ",accum r:" ~ String_valueOf(accumRedSize) ~ "g:" ~ String_valueOf(
				accumGreenSize) ~ "b:" ~ String_valueOf(
				accumBlueSize) ~ "a:" ~ String_valueOf(accumAlphaSize) ~ ",sampleBuffers:" ~ String_valueOf(
				sampleBuffers) ~ ",samples:" ~ String_valueOf(samples);
		return string;
	}
}
