 ...
 */
	...
	void setData(VARIANT* pData) {
		...
		default:
			...
			auto newPData = cast(VARIANT*) OS.GlobalAlloc(OS.GMEM_FIXED | OS.GMEM_ZEROINIT,
					VARIANT.sizeof);
 ...
 */
	override public String toString() {
		...
		case COM.VT_DISPATCH:
			return Format("VT_DISPATCH{{0x{:X}}",
					cast(void*)(dispatchData is null ? null : dispatchData));
		case COM.VT_UNKNOWN:
			return Format("VT_UNKNOWN{{0x{:X}}",
					cast(void*)(unknownData is null ? null : unknownData));
		case COM.VT_EMPTY:
			return "VT_EMPTY";
		case COM.VT_NULL:
			return "VT_NULL";
