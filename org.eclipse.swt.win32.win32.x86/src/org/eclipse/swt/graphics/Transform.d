 ...
 */
	public void invert() {
		if (isDisposed())
			SWT.error(SWT.ERROR_GRAPHIC_DISPOSED);
		if (Gdip.Matrix_Invert(handle) !is 0)
 ...
 */
	public void transform(float[] pointArray) {
		...
		if (pointArray is null)
			SWT.error(SWT.ERROR_NULL_ARGUMENT);
		Gdip.Matrix_TransformPoints(handle, cast(Gdip.PointF*) pointArray.ptr,
				cast(int) /*64bit*/ pointArray.length / 2);
	}
 ...
 */
	override public String toString() {
		...
		return Format("Transform {{{},{},{},{},{}}", elements[0], elements[1],
