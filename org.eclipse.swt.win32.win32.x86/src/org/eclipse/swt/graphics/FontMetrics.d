 ...
 */
	override public equals_t opEquals(Object object) {
		...
		if (auto metricObj = cast(FontMetrics) object) {
			...
			return handle.tmHeight is metric.tmHeight && handle.tmAscent is metric.tmAscent
				&& handle.tmDescent is metric.tmDescent && handle.tmInternalLeading is metric.tmInternalLeading
				&& handle.tmExternalLeading is metric.tmExternalLeading
				&& handle.tmAveCharWidth is metric.tmAveCharWidth && handle.tmMaxCharWidth is metric.tmMaxCharWidth
				&& handle.tmWeight is metric.tmWeight && handle.tmOverhang is metric.tmOverhang
				&& handle.tmDigitizedAspectX is metric.tmDigitizedAspectX
				&& handle.tmDigitizedAspectY is metric.tmDigitizedAspectY && //      handle.tmFirstChar is metric.tmFirstChar &&
				...
				&& handle.tmUnderlined is metric.tmUnderlined && handle.tmStruckOut is metric.tmStruckOut
 ...
 */
	override public hash_t toHash() {
		return handle.tmHeight ^ handle.tmAscent ^ handle.tmDescent ^ handle.tmInternalLeading ^ handle.tmExternalLeading
			^ handle.tmAveCharWidth ^ handle.tmMaxCharWidth ^ handle.tmWeight ^ handle.tmOverhang
			^ handle.tmDigitizedAspectX ^ handle.tmDigitizedAspectY ^ //      handle.tmFirstChar ^ handle.tmLastChar ^ handle.tmDefaultChar ^ handle.tmBreakChar ^
			handle.tmItalic
			^ handle.tmUnderlined ^ handle.tmStruckOut ^ handle.tmPitchAndFamily ^ handle.tmCharSet;
	}
