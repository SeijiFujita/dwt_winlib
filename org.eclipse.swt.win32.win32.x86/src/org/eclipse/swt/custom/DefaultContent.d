 ...
 */
	void moveAndResizeGap(int position, int size, int newGapLine) {
		...
		if (oldSize is 0) {
			...
			System.arraycopy(textStore, newGapStart, content, newGapEnd,
			...
			System.arraycopy(textStore, gapEnd, content, newGapEnd + delta,
			...
			System.arraycopy(textStore, gapEnd + delta, content, newGapEnd,
					content.length - newGapEnd);
		}
		textStore = content;
