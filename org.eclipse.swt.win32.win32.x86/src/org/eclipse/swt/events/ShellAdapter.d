...
class ShellDelegator : ShellAdapter {
	...
	private this(DFunc delShellActivated, DFunc delShellClosed,
			DFunc delShellDeactivated, DFunc delShellDeiconified, DFunc delShellIconified) {
	...
	override public void shellActivated(ShellEvent e) {
		if (delShellActivated !is null)
			delShellActivated(e);
	}

	override public void shellClosed(ShellEvent e) {
		if (delShellClosed !is null)
			delShellClosed(e);
	}

	override public void shellDeactivated(ShellEvent e) {
		if (delShellDeactivated !is null)
			delShellDeactivated(e);
	}

	override public void shellDeiconified(ShellEvent e) {
		if (delShellDeiconified !is null)
			delShellDeiconified(e);
	}

	override public void shellIconified(ShellEvent e) {
		if (delShellIconified !is null)
			delShellIconified(e);
	}
}
